...
def evader_bot_pose():
    rospy.Subscriber("/robot_0/base_pose_ground_truth", Odometry, callback1)
...
def evader_bot():
    publisher = rospy.Publisher("/robot_0/cmd_vel", Twist, queue_size = 10)
    rate = rospy.Rate(10)

    while not rospy.is_shutdown():
        rospy.Subscriber("/robot_0/base_scan", LaserScan, callback0)
